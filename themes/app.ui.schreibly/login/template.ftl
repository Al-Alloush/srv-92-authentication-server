...
<head>
    ...
    <#assign pannarFile = "pannar.png">
    <#if currentLang == "ar"><#assign pannarFile = "pannar-ar.png">
    <#elseif currentLang == "de"><#assign pannarFile = "pannar-de.png">
    <#elseif currentLang == "fr"><#assign pannarFile = "pannar-fr.png">
    <#elseif currentLang == "en"><#assign pannarFile = "pannar-en.png">
    </#if>
    <style>
        .login-pf body {
            background: url("${url.resourcesPath}/img/${pannarFile}") no-repeat center center fixed;
...
<div class="${properties.kcLoginClass!}">
    ...
    <div class="${properties.kcFormCardClass!}<#if showTabs> has-auth-tabs</#if>">
        <header class="${properties.kcFormHeaderClass!}">
            ...
            <#-- Language switcher is hidden; locale is managed by the client via ui_locales -->

            <#-- Logo and app name -->
            <div id="kc-logo-wrapper">
                <img src="${url.resourcesPath}/img/schreibly-logo.png" alt="${realm.displayName!'Schreibly'}" id="kc-logo-img" />
                <div id="kc-app-name">Schreibly</div>
            </div>
